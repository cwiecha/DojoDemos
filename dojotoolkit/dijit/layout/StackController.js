...
var _7=new _6({id:this.id+"_"+_3.id,label:_3.title,dir:_3.dir,lang:_3.lang,showLabel:_3.showTitle,iconClass:_3.iconClass,closeButton:_3.closable,title:_3.tooltip},_5);
dijit.setWaiState(_7.focusNode,"selected","false");
this.pane2handles[_3.id]=[this.connect(_3,"set",function(_8,_9){
