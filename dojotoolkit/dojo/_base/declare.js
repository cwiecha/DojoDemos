...
d.declare=function(_3b,_3c,_3d){
...
_3d=_3d||{};
var _3e,i,t,_3f,_40,_41,_42,_43=1,_44=_3c;
if(_2.call(_3c)=="[object Array]"){
_41=_8(_3c);
t=_41[0];
_43=_41.length-t;
_3c=_41[_43];
...
_41=[0];
if(_3c){
if(_2.call(_3c)=="[object Function]"){
t=_3c._meta;
_41=_41.concat(t?t.bases:_3c);
}else{
...
if(_3c){
for(i=_43-1;;--i){
_3.prototype=_3c.prototype;
_3e=new _3;
if(!i){
break;
}
t=_41[i];
(t._meta?_22:_1)(_3e,t.prototype);
_3f=new Function;
_3f.superclass=_3c;
_3f.prototype=_3e;
_3c=_3e.constructor=_3f;
}
}else{
_3e={};
}
...
if(_3e["-chains-"]){
_42=_1(_42||{},_3e["-chains-"]);
}
t=!_42||!_42.hasOwnProperty(_5);
_41[0]=_3f=(_42&&_42.constructor==="manual")?_34(_41):(_41.length==1?_31(_3d.constructor,t):_2c(_41,t));
_3f._meta={bases:_41,hidden:_3d,chains:_42,parents:_44,ctor:_3d.constructor};
_3f.superclass=_3c&&_3c.prototype;
_3f.extend=_2a;
_3f.prototype=_3e;
_3e.constructor=_3f;
_3e.getInherited=_1d;
_3e.inherited=_13;
_3e.isInstanceOf=_20;
if(_3b){
_3e.declaredClass=_3b;
d.setObject(_3b,_3f);
}
if(_42){
for(_40 in _42){
if(_3e[_40]&&typeof _42[_40]=="string"&&_40!=_5){
t=_3e[_40]=_36(_40,_41,_42[_40]==="after");
t.nom=_40;
}
}
}
