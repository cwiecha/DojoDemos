...
var _6=[],_7=_5.whichAnims||[0,1,2,3],_8=_5.direction||1,_9=[{start:"scale(1, 1) skewY(0deg)",end:"scale(0, 1) skewY("+(_8*30)+"deg)"},{start:"scale(0, 1) skewY("+(_8*30)+"deg)",end:"scale(-1, 1) skewY(0)"},{start:"scale(-1, 1) skewY(0deg)",end:"scale(0, 1) skewY("+(-_8*30)+"deg)"},{start:"scale(0, 1) skewY("+(-_8*30)+"deg)",end:"scale(1, 1) skewY(0)"}];
for(var i=0;i<_7.length;i++){
_6.push(dojo.animateProperty({node:_5.node,duration:_5.duration||600,properties:{transform:_9[_7[i]]}}));
}
