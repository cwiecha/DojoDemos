...
dojo.declare("dojox.charting.plot2d.Base",dojox.charting.Element,{constructor:function(_1,_2){
...
},connect:function(_10,_11){
this.dirty=true;
return dojo.connect(this,"plotEvent",_10,_11);
},events:function(){
...
},_calc:function(dim,_12){
if(this._hAxis){
if(!this._hAxis.initialized()){
this._hAxis.calculate(_12.hmin,_12.hmax,dim.width);
}
this._hScaler=this._hAxis.getScaler();
}else{
this._hScaler=dojox.charting.scaler.primitive.buildScaler(_12.hmin,_12.hmax,dim.width);
}
if(this._vAxis){
if(!this._vAxis.initialized()){
this._vAxis.calculate(_12.vmin,_12.vmax,dim.height);
}
this._vScaler=this._vAxis.getScaler();
}else{
this._vScaler=dojox.charting.scaler.primitive.buildScaler(_12.vmin,_12.vmax,dim.height);
}
},_connectEvents:function(_13,o){
if(!this._events){
this._events=[];
}
this._events.push(_13.connect("onmouseover",this,function(e){
o.type="onmouseover";
o.event=e;
this.plotEvent(o);
}),_13.connect("onmouseout",this,function(e){
o.type="onmouseout";
o.event=e;
this.plotEvent(o);
}),_13.connect("onclick",this,function(e){
o.type="onclick";
o.event=e;
this.plotEvent(o);
}));
