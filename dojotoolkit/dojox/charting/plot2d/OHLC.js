...
if(_10>=1){
var hl={x1:_10/2,x2:_10/2,y1:y-_18,y2:y-low},op={x1:0,x2:((_10/2)+((_15.series.stroke.width||1)/2)),y1:y-_16,y2:y-_16},cl={x1:((_10/2)-((_15.series.stroke.width||1)/2)),x2:_10,y1:y-_17,y2:y-_17};
shape=s.createGroup();
shape.setTransform({dx:x,dy:0});
var _19=shape.createGroup();
_19.createLine(hl).setStroke(_15.series.stroke);
_19.createLine(op).setStroke(_15.series.stroke);
_19.createLine(cl).setStroke(_15.series.stroke);
run.dyn.stroke=_15.series.stroke;
if(_13){
var o={element:"candlestick",index:j,run:run,plot:this,hAxis:this.hAxis||null,vAxis:this.vAxis||null,shape:_19,x:x,y:y-Math.max(_16,_17),cx:_10/2,cy:(y-Math.max(_16,_17))+(Math.max(_16>_17?_16-_17:_17-_16,1)/2),width:_10,height:Math.max(_16>_17?_16-_17:_17-_16,1),data:v};
this._connectEvents(shape,o);
}
}
if(this.animate){
this._animateOHLC(shape,y-low,_18-low);
}
}
}
run.dirty=false;
...
this.dirty=false;
return this;
},_animateOHLC:function(_1a,_1b,_1c){
dojox.gfx.fx.animateTransform(dojo.delegate({shape:_1a,duration:1200,transform:[{name:"translate",start:[0,_1b-(_1b/_1c)],end:[0,0]},{name:"scale",start:[1,1/_1c],end:[1,1]},{name:"original"}]},this.animate)).play();
}});
})();
}
